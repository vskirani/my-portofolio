        ...
        <section id="projects" className="py-24 lg:py-32 bg-white">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-12">
                    <div>
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <span className="text-xs font-medium uppercase tracking-widest text-gray-500">Projects</span>
                        </div>
                ...
                <div className="text-center mt-12">
                    <p className="text-gray-400 text-sm mb-4">Interested in collaborating?</p>
                    <a
                        href="#contact"
