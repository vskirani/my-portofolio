...
export default async function ProjectDetailPage({ params }: PageProps) {
    ...
    return (
        <main className="min-h-screen bg-white">
            {/* Hero Section */}
            <section className="pt-32 pb-8 px-6 bg-[#fdf2f8]">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="w-10 h-px bg-gradient-to-r from-[#ec4899] to-transparent text-xs font-medium uppercase tracking-widest text-gray-500" />
                        {project.projectType.name}
                    </div>

                    {/* Title */}
                    <h1 className="text-4xl sm:text-5xl lg:text-5xl font-semibold tracking-tight text-gray-800 mb-4 mt-8">
                        {project.title}
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-4">
                        {project.githubUrl && (
                            <a
                                ...
                                className="group inline-flex items-center gap-3 px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-200 rounded-full hover:border-gray-900 hover:text-gray-900 transition-all duration-300"
                            >
                                <svg
                                    className="w-4 h-4"
                                    fill="currentColor"
                                ...
                                <span className="relative">
                                    GitHub
                                    <span className="absolute left-0 -bottom-0.5 w-0 h-px bg-gray-900 transition-all duration-300 group-hover:w-full" />
                                </span>
                                <svg className="w-3 h-3 opacity-0 -translate-x-1 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <section className="py-20 px-6">
                <div className="max-w-4xl mx-auto space-y-8">
                    {/* Deskripsi */}
                    <p className="text-lg text-gray-500 mb-8 text-justify">
                        {project.description}
                    </p>
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 leading-relaxed pl-13 text-justify">
                            {project.problem}
                        </p>
                    </div>
                    ...
                    <div className="mt-20">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {project.designProcesses.map((img, i) => (
                                <div
                                    key={i}
                                    className="rounded-xl overflow-hidden border border-pink-100 shadow-sm hover:shadow-md transition-shadow"
                                >
                                    <img
                                        src={img.imageUrl}
